<template>
    ...
    <section v-else>
       <div class="container mt-3 bg-white rounded text-center">
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="form-group">
              <textarea class="form-control" placeholder="Please Comment Here!" 
              v-model="notes">
              </textarea>

            <button class="btn btn-lg btn-outline-success mx-2 mt-3 text-warning">
                Continue Shopping
            </button>
            </div>

            <p class="my-3 text-right">
              <router-link :to="{name:'item-list'}"></router-link>
            </p>
          </div>
          <div class="col-md-4">
            <h4>Please Choose OrderList</h4>
            <ul class="list-group">
            ...
            <button
              class="btn btn-lg btn-success mt-3" @click="order()">
                Check out
            </button>
          </div>
        </div>
